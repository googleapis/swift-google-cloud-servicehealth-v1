  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = ListEventsResponse().with { $0.events = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.servicehealth.v1.ListEventsResponse"
  }
  ...
  public func _getPaginatedItems() -> [Event] {
    return self.events
  }
