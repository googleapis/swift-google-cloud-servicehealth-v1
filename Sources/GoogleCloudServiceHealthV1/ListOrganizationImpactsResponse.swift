  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let organizationImpacts = CodingKeys(stringValue: "organizationImpacts")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      [OrganizationImpact].self, forKey: .organizationImpacts)
    {
      self.organizationImpacts = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.organizationImpacts, forKey: .organizationImpacts)
