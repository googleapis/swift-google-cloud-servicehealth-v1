...
public struct GetEventRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetEventRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetEventRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.servicehealth.v1.GetEventRequest"
  }
