...
Add `swift-google-cloud-servicehealth-v1` as a package dependency:

```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-servicehealth-v1.git --from 0.0.0-preview
```

Then add `GoogleCloudServiceHealthV1` to your target's dependencies:

```bash
swift package add-target-dependency GoogleCloudServiceHealthV1 <target-name> --package swift-google-cloud-servicehealth-v1
```
